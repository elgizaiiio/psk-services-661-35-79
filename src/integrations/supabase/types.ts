  ...
  public: {
    Tables: {
      ...
      limited_server_offer_claims: {
        ...
        Relationships: [
          {
            foreignKeyName: "limited_server_offer_claims_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "bolt_users"
            referencedColumns: ["id"]
      ...
      limited_server_purchases: {
        ...
        Relationships: [
          {
            foreignKeyName: "limited_server_purchases_offer_id_fkey"
            columns: ["offer_id"]
            isOneToOne: false
            referencedRelation: "limited_server_offers"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "limited_server_purchases_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "bolt_users"
            referencedColumns: ["id"]
      ...
      viral_withdrawals: {
        ...
        Relationships: [
          {
            foreignKeyName: "viral_withdrawals_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "bolt_users"
            referencedColumns: ["id"]
