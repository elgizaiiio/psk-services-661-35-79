              ...
              >
                ...
                {plan.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
                    <span className="px-4 py-1 rounded-full bg-amber-500 text-black text-xs font-bold flex items-center gap-1">
                ...
                <div
                  className={`p-6 rounded-2xl bg-card border ${tierStyles[plan.tier].border} ${
                    plan.popular ? 'ring-2 ring-amber-500/50 mt-2' : ''
                ...
                >
                  ...
                  <div className="flex items-baseline gap-3 mb-2">
                    ...
                    <span className="px-2 py-0.5 rounded-md bg-emerald-500/20 text-emerald-400 text-sm font-medium">
                      -{plan.discount}%
                    </span>
                  </div>
                  ...
                  <div className="mb-5">
                    <span
                      className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-full border ${tierStyles[plan.tier].badge} font-medium`}
                    >
